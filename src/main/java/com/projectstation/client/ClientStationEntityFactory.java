...
public class ClientStationEntityFactory extends StationEntityFactory {
    private static WeakHashMap<IEntity, EntityConfigurationDetails> entityConfigDetails = new WeakHashMap<>();

    public ClientStationEntityFactory(IEntityFactory base, IItemFactory itemFactory, IConfigurationFactory configurationFactory, IAnimationSceneModelFactory animationSceneModelFactory, IAssetStreamFactory assetStreamFactory, IRouteFactory routeFactory) {
